Popularized by [Redux](https://redux.js.org) and later became one of the [core hooks of React](https://reactjs.org/docs/hooks-reference.html#usereducer), the "reducer" suddenly became the way to manage state. It looks something like...
